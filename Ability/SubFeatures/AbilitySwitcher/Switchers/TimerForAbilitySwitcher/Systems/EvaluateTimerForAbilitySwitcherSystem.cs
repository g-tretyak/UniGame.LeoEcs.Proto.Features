namespace unigame.ecs.proto.Ability.SubFeatures.AbilitySwitcher.Switchers.TimerForAbilitySwitcher.Systems
{
	using System;
	using System.Linq;
	using Aspects;
	...
	[Serializable]
	[ECSDI]
	public class EvaluateTimerForAbilitySwitcherSystem : IProtoInitSystem, IProtoRunSystem
	{

namespace unigame.ecs.proto.Gameplay.Damage.Systems
{
    ...
    public class CheckDamageBlockSystem : IProtoInitSystem, IProtoRunSystem
    {
        ...
        private ProtoPool<BlockComponent> _blockPool;
        private ProtoPool<BlockableDamageComponent> _canBlockedPool;
